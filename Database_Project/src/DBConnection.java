...
public class DBConnection {
    ...
    private static String connectionURL = "jdbc:mysql://localhost:3360/kbride1db";
    /**
	...
	public ResultSet executeQuary(String quary) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException{
        ...
        connection = DriverManager.getConnection(connectionURL, USERNAME, PASSWORD);// Please use your database name here
